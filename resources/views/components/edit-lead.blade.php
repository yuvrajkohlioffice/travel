...
<div x-show="editOpen" x-transition.opacity
    ...
    <div @click.outside="closeEditModal"
        ...
        <div
            class="max-h-[75vh] overflow-y-auto p-6 space-y-4 scrollbar-thin scrollbar-thumb-gray-400 dark:scrollbar-thumb-gray-600 scrollbar-track-gray-100 dark:scrollbar-track-gray-700">
            ...
            <form @submit.prevent="submitEdit" class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <!-- Client Category -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-400">Client
                            Category</label>
                    ...
                    <!-- Lead Status -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-400">Lead Type </label>

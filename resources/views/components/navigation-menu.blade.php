<div class="z-50">
    <nav x-data="{ open: false }"
        class="bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-700 fixed w-screen flex shadow-lg justify-end top-0 mb-10 z-50">
                    ...
                    @if (Laravel\Jetstream\Jetstream::hasTeamFeatures())
                        <div class="ms-3 relative">
                            <x-dropdown align="right" width="60">
                                ...
                                <x-slot name="content">
                                    <div class="w-60 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200">
                                        <!-- Team Management -->

...
<div class="bg-white rounded-xl p-4 shadow">
    ...
    <div class="mt-3">
        <button type="button" onclick="sendPortalLink(this, {{ $lead->id }}, '{{ $lead->email }}')" 
                class="flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-3 py-1.5 rounded-lg text-sm font-medium transition w-full justify-center sm:w-auto">
            ...
            <span class="btn-text">Send Portal Link</span>
        </button>
    </div>
</div>
@endif

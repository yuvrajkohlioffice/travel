            ...
            <header
                ...
                <div class="flex items-center gap-4">
                    <div class="rounded-lg p-3 bg-gray-100/60">
                        <i class="fa-solid fa-box text-gray-700 text-lg"></i>
                    </div>
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-0.5">
                            Manage all package types — create, edit, and delete.
                        </p>
                    </div>
                </div>
                ...
                <a href="{{ route('package-types.create') }}"
                    ...
                    <span class="hidden sm:inline">Add Package Type</span>
                </a>
            </header>
            ...
            <section class="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden">
                <div class="p-4 md:p-6">
                    <div class="overflow-x-auto">
                        <table id="package-types-table" class="min-w-full border border-gray-300 rounded-lg">
